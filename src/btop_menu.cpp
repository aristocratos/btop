	...
	const vector<vector<vector<string>>> categories = {
	...
	#endif
		{
			...
			{"disks_filter",
				...
				"whitespace \" \".",
				"",
				"Only disks matching the filter will be shown. When the line begins with \033[3mexclude=\033[0m only the disks \033[3mnot\033[0m matching the filter will be shown.",
				"",
				"Examples:",
				"/boot /home/user",

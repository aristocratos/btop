   ...
   const array<array<string, 3>, 3> menu_normal = {
	...
	const vector<vector<vector<string>>> categories = {
	...
	#endif
		{
			...
			{"disks_order",
				"Optional custom display order for disks.",
				"",
				"Full path of mountpoints separated",
				"by whitespace \" \".",
				"Use \"swap\" to position the swap entry.",
				"",
				"Listed disks are shown first in the given",
				"order, remaining disks follow in their",
				"default order.",
				"",
				"Examples:",
				"/ swap /home",

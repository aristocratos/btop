...
namespace Config {
	...
	const vector<array<string, 2>> descriptions = {
		...
		{"presets",
		 "#* Define presets for the layout of the boxes. Preset 0 is always all boxes shown with default settings. "
		 "Max 9 presets.\n"
		 "#* Format: \"box_name:P:G,box_name:P:G\" P=(0 or 1) for alternate positions, G=graph symbol to use for "
		 "box.\n"
		...
		{"shown_boxes",
		 ...
		 "\"gpu5\", separate values with whitespace."},
		...
		{"disks_filter",
		 ...
		 "filter. Examples: disk_filter=\"/boot /home/user\", disks_filter=\"exclude=/boot /home/user\""},
		...
		{"io_graph_speeds",
		 ...
		 "separate disks with whitespace \" \".\n"
		...
		{"base_10_bitrate",
		 ...
		 "Mibps, etc.). \"Auto\" uses base_10_sizes."},

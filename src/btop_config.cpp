...
namespace Config {
	...
	const vector<array<string, 2>> descriptions = {
		...
		{"proc_follow_filter",	"#* Should the process list follow the filtered selection after first press of delete."},
	...
	std::unordered_map<std::string_view, bool> bools = {
		...
		{"proc_follow_filter", false},
		{"proc_follow_detailed", false},
		{"follow_process", false},
		{"follow_filtered", false},

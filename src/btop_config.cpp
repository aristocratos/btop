...
namespace Config {
	...
	const vector<array<string, 2>> descriptions = {
		...
		{"only_physical", 		"#* Filter out non physical disks. Set this to False to include network disks, RAM disks and similar. On macOS, also hides disk images and non-user-facing APFS volumes."},

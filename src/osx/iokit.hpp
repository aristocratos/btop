...
namespace IOReport {
    ...
    extern CFDictionaryRef (*CopyChannelsInGroup)(CFStringRef, CFStringRef, uint64_t, uint64_t, uint64_t);

    extern void (*MergeChannels)(CFDictionaryRef, CFDictionaryRef, CFTypeRef);

    extern IOReportSubscriptionRef (*CreateSubscription)(
        void*, CFMutableDictionaryRef, CFMutableDictionaryRef*, uint64_t, CFTypeRef
    );

    extern CFDictionaryRef (*CreateSamples)(IOReportSubscriptionRef, CFMutableDictionaryRef, CFTypeRef);

    extern CFDictionaryRef (*CreateSamplesDelta)(CFDictionaryRef, CFDictionaryRef, CFTypeRef);

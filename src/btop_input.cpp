...
namespace Input {
    ...
    const std::unordered_map<string, string> Key_escapes = {
        ...
        { "\x08", "backspace" }, { "[A", "up" },       { "OA", "up" },       { "[B", "down" },       { "OB", "down" },
        { "[D", "left" },        { "OD", "left" },     { "[C", "right" },    { "OC", "right" },      { "[2~", "insert" },
        { "[4h", "insert" },     { "[3~", "delete" },  { "[P", "delete" },   { "[H", "home" },       { "[1~", "home" },
        { "[F", "end" },         { "[4~", "end" },     { "[5~", "page_up" }, { "[6~", "page_down" }, { "\t", "tab" },
        { "[Z", "shift_tab" },   { "OP", "f1" },       { "OQ", "f2" },       { "OR", "f3" },         { "OS", "f4" },
        ...
        try {
            ...
            if (not filtering) {
                ...
                if (key == "q") {
                    ...
                    if (key == "p") {
                        if (++Config::current_preset >= (int)Config::preset_list.size())
